...
@section('title', 'Kelola Produk Perlengkapan')

@push('styles')
<link rel="stylesheet" href="{{ asset('css/admin/produk/perlengkapan/index.css') }}">
@endpush
            ...
            <table class="table table-hover text-center" id="produkTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.perlengkapan.edit', $p->id) }}" class="btn btn-sm btn-edit">Edit</a>
                            <form action="{{ route('admin.perlengkapan.destroy', $p->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
