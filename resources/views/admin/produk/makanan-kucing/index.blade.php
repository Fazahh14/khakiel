...
@section('title', 'Kelola Produk Makanan Kucing')

@push('styles')
<link rel="stylesheet" href="{{ asset('css/admin/produk/makanankucing/index.css') }}">
@endpush
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.makanan-kucing.destroy', $p->id) }}"
